  ...
  return (
    <ContactWrapper id="about">
      <div className="Container">
        <div className="SectionTitle" data-num="02" data-kicker="Profile">
          About Me
        </div>
        <div className="BigCard">
          <div className="AboutGrid">
            <div className="AboutFigure">
            ...
            <div className="AboutBio">
              ...
              <ScrollAnimation animateIn="fadeIn" animateOnce>
                ...
                Bootstrap, allowing me to design and develop responsive,
              ...
              <ScrollAnimation animateIn="fadeIn" animateOnce>
                In addition to custom web development, I also build and
                customize websites using <strong>WordPress</strong> with{" "}
                <strong>Elementor</strong>, creating flexible, easy-to-manage,
                and performance-optimized sites tailored to client needs.
              </ScrollAnimation>
          ...
          <div className="tagline2">{"// Confident working with"}</div>
